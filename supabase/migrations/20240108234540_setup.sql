...
AS $$
DECLARE
  project_url TEXT := 'https://mgzapwsgvnsusuutvsbu.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1nemFwd3Nndm5zdXN1dXR2c2J1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MzA2MjAzNiwiZXhwIjoyMDU4NjM4MDM2fQ.PCgxWc1PVw-cbqQneY04c2CfC_wQ0izeWanL6POZLYQ'; -- full access needed for http request to storage
